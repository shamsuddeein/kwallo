...
const COMP_TABS = ['All', 'EPL', 'NPFL', 'UCL', 'Super Eagles']
...
export default function ResultsPage() {
  ...
  const finished = MOCK_TODAY_MATCHES.filter((m) => m.status === 'FT')
      ...
      <div className="max-w-[1100px] mx-auto px-6 py-10 pb-24 md:pb-10">
        ...
        {filtered.length === 0 ? (
          <div className="bg-white border-2 border-[#0D1B2A] rounded-2xl card-shadow p-14 text-center">
            ...
            <p className="text-[#6B7280] text-sm">Check back after matches finish.</p>
          </div>
        ) : (
